(self["webpackChunkgame"] = self["webpackChunkgame"] || []).push([
  [834],
  {
        ...
        c + "" !== "a=2" &&
          n(
            ...
            function (e) {
              ...
              while (c < L)
                ((s = n[c++]),
                  M || s.key === d ? ((M = !0), u(this, s.key)) : h++);
              while (h < L)
                ((s = n[h++]),
                  (s.key === d && s.value === _) || o(this, s.key, s.value));
            },
          ...
          fromCodePoint: function (e) {
            ...
            while (n > s) {
              ...
              a[s] =
                t < 65536
                  ? d(t)
                  : d(55296 + ((t -= 65536) >> 10), (t % 1024) + 56320);
            }
            return o(a, "");
          },
        },
    ...
    40834: function (e, t, a) {
      ...
      class L {
        constructor(e) {
          ((0, o.A)(this, "options", void 0), (this.options = e));
        }
        consume(e, t) {
          return e === l
            ? (t(new y(this.options)), "")
            : e === c && this.options.encodePlaintextTagDelimiters
              ? M
              : e;
        }
      }
      ...
      (function (e) {
        ((e[(e["Allowed"] = 0)] = "Allowed"),
          (e[(e["Disallowed"] = 1)] = "Disallowed"));
      })(Y || (Y = {}));
      class y {
        constructor(e) {
          ((0, o.A)(this, "options", void 0),
            (0, o.A)(this, "nameBuffer", ""),
            (0, o.A)(this, "isClosingTag", !1),
            (this.options = e));
        }
        consume(e, t) {
          if (0 === this.nameBuffer.length) {
            if (u(e))
              return (
                t(new L(this.options)),
                (this.options.encodePlaintextTagDelimiters ? h : "<") + e
              );
            if ("/" === e) return ((this.isClosingTag = !0), "");
          }
          return u(e)
            ? this.isNameBufferAnAllowedTag()
              ? (t(new f(Y.Allowed, this.options)),
                l + (this.isClosingTag ? "/" : "") + this.nameBuffer + e)
              : (t(new f(Y.Disallowed, this.options)),
                this.options.tagReplacementText)
            : e === l
              ? ((this.nameBuffer += h), "")
              : e === c
                ? (t(new L(this.options)),
                  this.isNameBufferAnAllowedTag()
                    ...
                    : this.options.tagReplacementText)
                : "-" === e && "!-" === this.nameBuffer
                  ? (t(new k(this.options)), "")
                  : ((this.nameBuffer += e), "");
        }
        isNameBufferAnAllowedTag() {
          const e = this.nameBuffer.toLowerCase();
          return this.options.allowedTags
            ? this.options.allowedTags.has(e)
            : !!this.options.disallowedTags &&
                !this.options.disallowedTags.has(e);
        }
      }
      class f {
        constructor(e, t) {
          ((0, o.A)(this, "mode", void 0),
            (0, o.A)(this, "options", void 0),
            (this.mode = e),
            (this.options = t));
        }
        consume(e, t) {
          return (
            e === c
              ? t(new L(this.options))
              : m(e) && t(new p(this.mode, e, this.options)),
            this.mode === Y.Disallowed ? "" : e === l ? h : e
          );
        }
      }
      class p {
        constructor(e, t, a) {
          ((0, o.A)(this, "mode", void 0),
            (0, o.A)(this, "quoteCharacter", void 0),
            (0, o.A)(this, "options", void 0),
            (this.mode = e),
            (this.quoteCharacter = t),
            (this.options = a));
        }
        consume(e, t) {
          return (
            e === this.quoteCharacter && t(new f(this.mode, this.options)),
            this.mode === Y.Disallowed ? "" : e === l ? h : e === c ? M : e
          );
        }
      }
      class k {
        constructor(e) {
          ((0, o.A)(this, "options", void 0),
            (0, o.A)(this, "consecutiveHyphens", 0),
            (this.options = e));
        }
        consume(e, t) {
          return (
            ">" === e && this.consecutiveHyphens >= 2
              ? t(new L(this.options))
              : "-" === e
      ...
      const D = { tagReplacementText: "", encodePlaintextTagDelimiters: !0 };
      class g {
        constructor(e = {}) {
          ((0, o.A)(this, "state", void 0),
            (0, o.A)(this, "transitionFunction", void 0),
            (this.state = new L((0, _.A)((0, _.A)({}, D), e))),
            (this.transitionFunction = (e) => {
              this.state = e;
            }));
        }
        consume(e) {
          let t = "";
          for (const a of e)
            t += this.state.consume(a, this.transitionFunction);
          return t;
        }
      }
      function w(e, t = {}) {
        return new g(t).consume(e);
      }
      let T = class extends d.lD {
        getHashParam(e, t) {
          if (!this.$route.hash) return t;
          const a = new URLSearchParams(this.$route.hash.substring(1)),
            n = a.get(e);
          return n || t;
        }
        setHashParam(e, t) {
          const a = this.$route.hash || "#",
            n = new URLSearchParams(a.substring(1));
          t ? n.set(e, t) : n.delete(e);
          const s = this.$route.fullPath.split("#")[0];
          this.$router.replace(
            s + ([...n.keys()].length ? "#" + n.toString() : ""),
          );
        }
        numberParam(e, t) {
          const a = this.$route.query[e];
          if (Array.isArray(a))
            throw new TypeError(`Number parameter "${e}" is invalid type`);
          if (t && "string" !== typeof a)
            throw new TypeError(`Missing number parameter "${e}"`);
          return a ? parseInt(a, 10) : void 0;
        }
        humanise(e) {
          return (0, s.startCase)(e);
        }
        stripHtml(e) {
          return w(e);
        }
        replaceUnderscoresForSpeech(e, t) {
          let a = !1;
          const n = e.split("");
        ...
        prepareQuestionForSpeech(e, t, a) {
          let n = "";
          return (
            e.forEach((e) => {
              if (!e) return;
              let t = "";
              ((t = "html" === e.type ? w(e.value) : e.value),
                (n += `${n.length ? ". " : ""}${this.replaceUnderscoresForSpeech(t, a)}`));
            }),
            t.forEach((e) => {
              n += `${n.length ? ". " : ""}${this.replaceUnderscoresForSpeech(e, a)}`;
            }),
            n
          );
        }
        truncate(e, t = 50) {
          return e.length <= t ? e : e.slice(0, t).trim() + "…";
        }
        ellipsis(e, t = 50) {
          return e
            ? e.length <= t
              ? e
              : e.slice(0, t / 2).trim() + " … " + e.slice(-t / 2)
            : "";
        }
        shuffleArray(e) {
        ...
        getSassoonClassNameForLocale(e, t) {
          const a = e || "en-gb";
          let n = "";
          switch (a) {
            case "en-us":
          ...
          return `font-is-sassoon${n}${t && !n ? "-curly" : ""}`;
        }
        getSassoonFontForLocale(e) {
          const t = e || "en-gb";
          switch (t) {
            case "en-us":
              return "SassoonUs";
        ...
        levenshteinDistance(e, t) {
          const a = Array.from(Array(e.length + 1), () =>
            Array(t.length + 1).fill(0),
          );
          for (let n = 0; n <= e.length; n++) a[n][0] = n;
          for (let n = 0; n <= t.length; n++) a[0][n] = n;
          for (let n = 1; n <= e.length; n++)
            for (let s = 1; s <= t.length; s++) {
              const r = e[n - 1] === t[s - 1] ? 0 : 1;
              a[n][s] = Math.min(
                a[n - 1][s] + 1,
                a[n][s - 1] + 1,
                a[n - 1][s - 1] + r,
      ...
      (!m.has("a", 2) && m.has("a", void 0)) ||
        n(
          ...
          function (e) {
            ...
            var s = r(a),
              d = 0;
            while (d < n.length) if (n[d++] === s) return !0;
            return !1;
          },
          { enumerable: !0, unsafe: !0 },
        );
    ...
    95093: function (e, t, a) {
      ((e = a.nmd(e)),
        (function (t, a) {
          ...
          function I(e, t) {
            return e.isValid()
              ? ((t = G(t, e.localeData())), (N[t] = N[t] || U(t)), N[t](e))
          ...
          function mt(e, t, a) {
            ...
            return a
              ? "MMM" === t
                ? ((s = Be.call(this._shortMonthsParse, i)),
                  -1 !== s ? s : null)
                : ((s = Be.call(this._longMonthsParse, i)), -1 !== s ? s : null)
              : "MMM" === t
                ? ((s = Be.call(this._shortMonthsParse, i)),
                  -1 !== s
                    ? s
                    : ((s = Be.call(this._longMonthsParse, i)),
                      -1 !== s ? s : null))
                : ((s = Be.call(this._longMonthsParse, i)),
                  -1 !== s
                    ? s
          ...
          function Ut(e, t, a) {
            ...
            return a
              ? "dddd" === t
                ? ((s = Be.call(this._weekdaysParse, i)), -1 !== s ? s : null)
                : "ddd" === t
                  ? ((s = Be.call(this._shortWeekdaysParse, i)),
                    -1 !== s ? s : null)
                  : ((s = Be.call(this._minWeekdaysParse, i)),
                    -1 !== s ? s : null)
              : "dddd" === t
                ? ((s = Be.call(this._weekdaysParse, i)),
                  -1 !== s
                    ? s
                    : ((s = Be.call(this._shortWeekdaysParse, i)),
                      -1 !== s
          ...
          function Ra(e) {
            ...
            ((t = e._w),
              null != t.GG || null != t.W || null != t.E
                ? ((r = 1),
                  (i = 4),
                  (a = Fa(t.GG, e._a[ze], gt($a(), 1, 4).year)),
                  (n = Fa(t.W, 1)),
                  (s = Fa(t.E, 1)),
                  (s < 1 || s > 7) && (_ = !0))
            ...
            return (
              ...
              null === t || (void 0 === a && "" === t)
                ...
                : ("string" === typeof t && (e._i = t = e._locale.preparse(t)),
                  w(t)
                    ? new g(pa(t))
                    : (l(t) ? (e._d = t) : i(a) ? Ua(e) : a ? Ja(e) : qa(e),
                      y(e) || (e._d = null),
                      e))
            );
          }
          ...
          function hn(e, t) {
            ...
            return t._isUTC
              ? ((a = t.clone()),
                (n =
                  (w(e) || l(e) ? e.valueOf() : $a(e).valueOf()) - a.valueOf()),
          ...
          function Un(e, t) {
            ...
            return this.format(i || this.localeData().calendar(r, this, $a(a)));
          }
          function In() {
            return new g(this);
          }
          ...
          function ns(e, t) {
            return this.isValid() && ((w(e) && e.isValid()) || $a(e).isValid())
          ...
          function Es(e) {
            return (
              _(this, "_erasNameRegex") || Us.call(this),
              e ? this._erasNameRegex : this._erasRegex
            );
          }
          function Fs(e) {
            return (
              _(this, "_erasAbbrRegex") || Us.call(this),
              e ? this._erasAbbrRegex : this._erasRegex
            );
          }
          function zs(e) {
            return (
              _(this, "_erasNarrowRegex") || Us.call(this),
    ...
    98406: function (e, t, a) {
      ...
      var n = a(46518),
        ...
        U = J && J.prototype,
        I = s.TypeError,
        G = s.encodeURIComponent,
        V = String.fromCharCode,
        q = i("String", "fromCodePoint"),
        B = parseInt,
        $ = _("".charAt),
        K = _([].join),
        Z = _([].push),
        ...
        de = function (e, t) {
          var a = ae(e, t, t + 2);
          return ne(ie, a) ? B(a, 16) : NaN;
        },
        _e = function (e) {
          for (var t = 0, a = 128; a > 0 && 0 !== (e & a); a >>= 1) t++;
          return t;
        },
        oe = function (e) {
          var t = null;
            ...
            if ("%" === s) {
              ...
              if (0 === i) s = V(r);
                ...
                var d = [r],
                  _ = 1;
                while (_ < i) {
                  if ((n++, n + 3 > t || "%" !== $(e, n))) break;
                  var o = de(e, n + 1);
                  if (o !== o) {
                    n += 3;
                    break;
                  }
                  if (o > 191 || o < 128) break;
                  (Z(d, o), (n += 2), _++);
                }
                if (d.length !== i) {
                  a += re;
        ...
        Me = M(
          function (e, t) {
            E(this, { type: A, target: F(e).entries, index: 0, kind: t });
          },
          W,
          function () {
            var e = z(this),
              t = e.target,
              a = e.index++;
            if (!t || a >= t.length) return ((e.target = null), H(void 0, !0));
            var n = t[a];
            switch (e.kind) {
              case "keys":
                return H(n.key, !1);
          ...
          if (u) {
            ...
            while (!(n = d(a, t)).done) {
              if (
                ((s = b(D(n.value))),
                (r = s.next),
                (i = d(r, s)).done || (_ = d(r, s)).done || !d(r, s).done)
              )
                throw new I("Expected sequence with length 2");
              Z(o, { key: w(i.value), value: w(_.value) });
            }
          } else for (var m in e) f(e, m) && Z(o, { key: m, value: w(e[m]) });
        },
      ...
      if (
          ...
          ye,
          {
            append: function (e, t) {
              ...
              (j(arguments.length, 2),
                Z(a.entries, { key: w(e), value: w(t) }),
                o || this.length++,
                a.updateURL());
            },
            delete: function (e) {
              var t = F(this),
                a = j(arguments.length, 1),
                n = t.entries,
                s = w(e),
                r = a < 2 ? void 0 : arguments[1],
                i = void 0 === r ? r : w(r),
                d = 0;
              while (d < n.length) {
                var _ = n[d];
                if (_.key !== s || (void 0 !== i && _.value !== i)) d++;
                else if ((ee(n, d, 1), void 0 !== i)) break;
              }
            ...
            get: function (e) {
              ...
              for (var a = w(e), n = 0; n < t.length; n++)
            ...
            getAll: function (e) {
              var t = F(this).entries;
              j(arguments.length, 1);
              for (var a = w(e), n = [], s = 0; s < t.length; s++)
                t[s].key === a && Z(n, t[s].value);
              return n;
            },
            has: function (e) {
              var t = F(this).entries,
                a = j(arguments.length, 1),
                n = w(e),
                s = a < 2 ? void 0 : arguments[1],
                r = void 0 === s ? s : w(s),
                i = 0;
              while (i < t.length) {
                var d = t[i++];
                if (d.key === n && (void 0 === r || d.value === r)) return !0;
              }
              return !1;
            },
            set: function (e, t) {
              ...
              j(arguments.length, 1);
              for (
                var n, s = a.entries, r = !1, i = w(e), d = w(t), _ = 0;
                _ < s.length;
                _++
              )
                ((n = s[_]),
                  n.key === i &&
                    (r ? ee(s, _--, 1) : ((r = !0), (n.value = d))));
              (r || Z(s, { key: i, value: d }),
                o || (this.size = s.length),
                a.updateURL());
            },
            sort: function () {
              var e = F(this);
            ...
            forEach: function (e) {
              var t,
                ...
                s = 0;
              while (s < a.length) ((t = a[s++]), n(t.value, t.key, this));
            },
            keys: function () {
        ...
        m(ye, O, ye.entries, { name: "entries" }),
        m(
          ye,
          "toString",
          function () {
        ...
        h(Ye, W),
        n({ global: !0, constructor: !0, forced: !u }, { URLSearchParams: Ye }),
        !u && y(J))
      ) {
        var fe = _(U.has),
          pe = _(U.set),
            ...
            if (g(e)) {
              ...
              if (k(a) === W)
                return (
                  ...
                  T(e, { body: v(0, w(a)), headers: v(0, t) })
                );
            }
            return e;
          };
        if (
          (y(N) &&
            n(
              ...
              {
                fetch: function (e) {
                  return N(e, arguments.length > 1 ? ke(arguments[1]) : {});
                },
              },
            ),
          y(R))
          ...
          var De = function (e) {
            return (
              Y(this, C),
              new R(e, arguments.length > 1 ? ke(arguments[1]) : {})
            );
          };
          ((C.constructor = De),
            (De.prototype = C),
      ...
      e.exports = { URLSearchParams: Ye, getState: F };
    },
    98721: function (e, t, a) {
      "use strict";
      var n = a(43724),
        s = a(79504),
        r = a(62106),
