    ...
    7411: function (e, t, a) {
      ...
      var s = a(62029),
        ...
        o = {
          ...
          name: "Picnic",
          description:
            "Protect your picnic basket! Those sneaky ants are taking a shortcut!",
          royalGuardAreas: [
            { x: 5.15, y: 3.8 },
            { x: 7.7, y: 3.8 },
          ],
        ...
        r = {
          ...
          name: "Ruins",
          description:
            "An ancient hive is under attack! Enemies will take two routes, so be careful!",
          royalGuardAreas: [
            { x: 13.3, y: 3.8 },
            { x: 10.6, y: 3.8 },
          ],
    ...
    66487: function (e, t, a) {
          ...
          return e.initialised
            ? a(
                ...
                [
                    ...
                    a("main", [
                      ...
                      a(
                        ...
                        [
                          a(
                            "div",
                            { staticClass: "tower-game-menu__main__inner" },
                            [
                              "map" === e.show
                                ? a(
                                    "div",
                                    { staticClass: "tower-game-menu__maps" },
                                    [
                                      ...
                                      e.needsToDoMiniDiagnostic
                                        ? a(
                                            ...
                                            {
                                              staticClass:
                                                "tower-game-menu__main__no-stage",
                                            },
                                            [
                                              a(
                                                "a",
                                      ...
                                      e.maps && e.maps.length
                                                  ...
                                                  a(
                                                    ...
                                                    [
                                                      a(
                                                        ...
                                                        {
                                                          staticClass:
                                                            "tower-game-menu__map__img",
                                                        },
                                                        [
                                                          a("img", {
                                                            attrs: {
                                                              src:
                                                                "/images/towergame/map_icons/" +
                                                                t.ident +
                                                                ".png",
                                                              draggable:
                                                                "false",
                                                      ...
                                                      a(
                                                        ...
                                                        [
                                                          ...
                                                          a(
                                                            ...
                                                            {
                                                              staticClass:
                                                                "tower-game-menu__map__title__description",
                                                            },
                                                            [
                                                              e._v(
                                                                " " +
                                                                    ...
                                                                    a("li", [
                                                                      ...
                                                                      a(
                                                                        ...
                                                                        [
                                                                          e._v(
                                                                            e._s(
                                                                              t.data.highScore.toLocaleString(),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                        ...
                                        : a(
                                            ...
                                            {
                                              staticClass:
                                                "tower-game-menu__maps__loading",
                                            },
                                            [a("span", [e._v("Loading...")])],
                                          ),
                                    ],
                  ...
                  e.showContinueCampaignModal &&
                  e.selectedMap &&
                  e.selectedMap.data &&
                  e.selectedMap.data.activeCampaign
                  ...
                  "no-stage" === e.show
                    ? a(
                        ...
                        {
                          staticClass:
                            "tower-game-menu__no-stage tower-game-menu__modal",
                        },
                        [
                          a("div", {
                            staticClass: "tower-game-menu__modal-bg",
                          }),
                          a(
                            "div",
                            { staticClass: "tower-game-menu__modal__inner" },
                            [
                              a("h2", [e._v("Warning")]),
                              a("h3", [
                                e._v("Mastery Zone data not available"),
                              ]),
                              a("p", [
                                e._v(
                                  "Please complete one session of Mastery Zone before playing Bee Sieged",
                                ),
                              ]),
                              a(
                                "div",
                                {
                                  staticClass:
                                    "tower-game-menu__modal__actions",
                                },
                                [
                                  a(
                                    "button",
                                    {
                                      staticClass: "tower-game-button",
                                      on: {
                                        click: e.conintueWithEphemeralGame,
                                      },
                                    },
                                    [
                                      a("span", [
                                        e._v("Continue Without Saving"),
                                      ]),
                                    ],
                                  ),
                                  a(
                                    ...
                                    {
                                      staticClass: "tower-game-button",
                                      on: { click: e.redirectToMiniDiagnostic },
                                    },
                                    [a("span", [e._v("Play Mastery Zone")])],
                                  ),
                                ],
                              ),
                            ],
                  ...
                  a(
                    "div",
                    { attrs: { id: "sideMenu" } },
                    [a("SideBarMenu", { attrs: { location: "spelling" } })],
                    1,
                  ),
                  a(
                    "a",
        ...
        i = [
          function () {
            var e = this,
              t = e.$createElement,
              a = e._self._c || t;
            return a("div", { staticClass: "tower-game-menu__logo" }, [
              a("img", {
                attrs: {
                  src: "/images/towergame/beesieged_logo.png",
                  draggable: "false",
                },
              }),
            ]);
          ...
          function () {
            var e = this,
              ...
              a = e._self._c || t;
            return a("span", [
              a("i", { staticClass: "mdi mdi-alert" }),
              e._v(" Game data, score and honeypot earnings will not be saved"),
            ]);
          },
          function () {
            var e = this,
              t = e.$createElement,
              a = e._self._c || t;
            return a("div", { staticClass: "tower-game-menu__map__play" }, [
              a("img", {
                attrs: { src: "/images/playButton.png", draggable: "false" },
              }),
            ]);
          },
        ],
      ...
      let d = class extends (0, l.Xe)() {
        ...
        get canPlayAdaptive() {
          ...
          return (
            !!(0, h.Cf)(t) &&
            ("full" === e.spelling_access_level ||
              "trial" === e.spelling_access_level) &&
        ...
        async created() {
          this.canPlayAdaptive
            ? (this.$route.params &&
                this.$route.params.navigatedFromGame &&
                (this.show = "map"),
              this.$route.query.firstPlay &&
                ((this.firstPlay = !0), this.$router.replace({})),
              await this.getAdaptiveProgress(),
              await this.loadMaps(),
        ...
        get locale() {
          return (
            (this.$store.state.user && this.$store.state.user.voice_locale) ||
            "en_GB"
          );
        }
          ...
          if (this.$store.state.user)
            try {
              ...
              if (!t)
                return (
                  (this.firstPlay = !0),
                  (this.needsToDoMiniDiagnostic = !0),
                  !1
                );
            } catch (e) {
              return (
          ...
          try {
            const e = await u.jIY.createMiniDiagnosticGameSession(),
              t = (0, n.A)(
                ...
                {},
                {
                  words: [e.currentWordData.text],
                  wordsData: [e.currentWordData],
                  gameType: "adaptive spelling mini-diagnostic",
                  list: "",
                  difficulty: 4,
                },
              ),
              a = this.locale
                ? this.locale.split("_").join("-").toLowerCase()
                : "en-gb",
              s = {
                session: t,
                theme: "spelling",
                adaptive: !0,
                returnURL: `${p.A.serverInfo.game}${a}/beesieged`,
              };
            this.$router.push({ name: "SpellingGame", params: s });
          } catch (e) {
            e instanceof Error &&
              (console.error(e), this.$router.push({ name: "MainMenu" }));
          }
        }
        ...
        transitionToGame(e, t = "") {
          ...
          const i = {
            map: e,
            campaign_id: t,
            isEphemeralGame: this.needsToDoMiniDiagnostic,
            maxRound: s.maxCompletedRound,
            maxScore: s.highScore,
          };
          setTimeout(() => {
            this.$router.push({
              name: "Bee Sieged Game",
              query: { firstPlay: this.firstPlay ? "true" : void 0 },
              params: i,
            });
          }, 600);
        }
        ...
        async loadMaps() {
          ...
          this.maps = t.map((t) => {
            ...
            return {
              ...
              available: !this.firstPlay || "beehive" === t.key,
              data: a,
            };
          });
        }
